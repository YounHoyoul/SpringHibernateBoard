...
<table class="data" border="0" id="boardtable">
	...
	<c:if  test="${!empty boardList}">
        <c:forEach items="${boardList}" var="board">
            <tr id="detailboard/${board.id}">
                <td><a href="#">${board.title}</a></td>
                <td align="center">${board.hit}</td>
                <td>
                    <a href="#" class="popup" id="modifyboard/${board.id}"><spring:message code="boardmain.modify"/></a>
                    <a href="deleteboard/${board.id}" id=""><spring:message code="boardmain.delete"/></a>
                </td>
            </tr>
        </c:forEach>   
	</c:if>
...
<div id="adddiv" style="display:none;">
    <form:form name="addform" id="addform" action="addboard" method="POST">
    <table>
        <tr>
